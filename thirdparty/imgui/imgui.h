...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(float size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL);
...
namespace ImGui
{
    ImVec4 RGBAtoIm4(int r, int g, int b, int a = 255);
    bool          SelectableSkin(const char* label, const ImVec4& colour, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size_arg = ImVec2(0, 0));
}
